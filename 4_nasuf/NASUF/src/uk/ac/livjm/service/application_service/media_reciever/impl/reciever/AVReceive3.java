 ...
 */
package NASUF.src.uk.ac.livjm.service.application_service.media_reciever.impl.reciever;
...
public class AVReceive3 implements ReceiveStreamListener, SessionListener, 
	...
	if (evt instanceof RemotePayloadChangeEvent) {
		...
		playerWindows.removeElement(pw);
            ...
            //I have added this because you may not get the Bye message,
            //i.e. you only get the bye message when the transmitter
            //is closed. However the transmitter may still be open but
            //it does not transmit any data. In this instance
            //you need to check for inactiveReceiveStreamEvents.
            PlayerWindow pw;
            for(int i = 0; i < playerWindows.size(); i++){
                pw = (PlayerWindow) playerWindows.remove(i);
                pw.close();
                pw = null;
            }
        }
